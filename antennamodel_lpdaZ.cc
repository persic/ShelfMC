...
void LPDAZ::LoadData(double theta_d, double phi_d){
...
void LPDAZ::CheckBoundaries(double &theta_d, double &phi_d){
...
TVector3*  LPDAZ::GetVector(double zenith,double azimuth){
...
LPDAZ::AntennaAngles LPDAZ::WPLD2Cartesian(TVector3* v){
        /// Conversion from WiPLD to Cartesian (same conversion as other)
        AntennaAngles ant_angles = Cartesian2WPLD(v);
        return ant_angles;
        }

LPDAZ::AntennaAngles LPDAZ::GetThetaAndPhiFlexible(double zenith,
                                                 double azimuth,
...
double LPDAZ::InterpolateToSingleFrequency(double freq, int nfreq, float* frequencies, double* gains){
...
double LPDAZ::GetEffectiveHeight(double gain,
                                double freq,
                                double ant_Z,
                                double c=2.99792e8,
