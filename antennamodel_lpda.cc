...
TVector3* LPDA::GetPhiHat(TVector3* v){
...
TVector3* LPDA::GetThetaHat(TVector3* v){
    double theta = v->Theta();
    double phi = v->Phi();
...
double LPDA::GetEffectiveLength(double Z,
                                double wavelength,
                                double I_phi,
                                double I_theta,
                                double* n_boresight,
...
TVector3* LPDA::AlignVector(double* n_boresight,
                            double* n_eplane,
                            double* n_arrivaldir){
